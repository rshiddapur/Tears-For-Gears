...
Int2:
	...
	Test2:  ; P.S. "Test1" is a terrible, non-descriptive label
 	CALL   GetThetaErr ; get the heading error
 	CALL   Abs         ; absolute value
 	OUT    LCD         ; useful debug info
 	ADDI   -1          ; check if within 5 degrees of target
...
Int3:
	...
	Test3:  ; P.S. "Test1" is a terrible, non-descriptive label
 	CALL   GetThetaErr ; get the heading error
 	CALL   Abs         ; absolute value
 	OUT    LCD         ; useful debug info
 	ADDI   -1          ; check if within 5 degrees of target
...
Int4:
	...
	Test4:  ; P.S. "Test1" is a terrible, non-descriptive label
 	CALL   GetThetaErr ; get the heading error
 	CALL   Abs         ; absolute value
 	OUT    LCD         ; useful debug info
 	ADDI   -1          ; check if within 5 degrees of target
 	JPOS   Test4       ; if not, keep testing
...
;Test3:
;	IN     DIST5       ; get sonar2 distance
;	OUT    SSEG1       ; useful debug info
;	ADDI   -914        ; 3ft in mm
;	
;	JNEG   Test2
;
;	JUMP   Test3       ; still going
